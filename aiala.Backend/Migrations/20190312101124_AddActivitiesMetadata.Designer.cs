...
namespace aiala.Backend.Migrations
{
    ...
    [Migration("20190312101124_AddActivitiesMetadata")]
    partial class AddActivitiesMetadata
    {
            ...
            modelBuilder.Entity("aiala.Backend.Data.Activity", b =>
                {
                    ...
                    b.OwnsOne("aiala.Backend.Data.ActivityMetadata", "Metadata", b1 =>
                        {
                            ...
                            b1.Property<DateTimeOffset>("TimeCreated");

                            b1.ToTable("Activities","aiala");

                            b1.HasOne("aiala.Backend.Data.Activity")
                                .WithOne("Metadata")
                                .HasForeignKey("aiala.Backend.Data.ActivityMetadata", "ActivityId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
