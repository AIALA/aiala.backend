...
namespace aiala.Backend.Migrations
{
    ...
    [Migration("20190318102128_AddIsDeletedToStep")]
    partial class AddIsDeletedToStep
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aiala.Backend.Data.Schedule.ScheduledStep", b =>
                {
                    b.HasOne("aiala.Backend.Data.Schedule.ScheduledTask")
                        .WithMany("Steps")
            ...
            modelBuilder.Entity("aiala.Backend.Data.Schedule.ScheduledTask", b =>
                {
                    b.HasOne("aiala.Backend.Data.Schedule.Day")
                        .WithMany("Tasks")
                        .HasForeignKey("DayId");
            ...
            modelBuilder.Entity("aiala.Backend.Data.Tasks.Step", b =>
                {
                    b.HasOne("aiala.Backend.Data.Tasks.AppTask")
                        .WithMany("Steps")
            ...
            modelBuilder.Entity("aiala.Backend.Data.Templates.ScheduledTaskTemplate", b =>
                {
                    b.HasOne("aiala.Backend.Data.Templates.DayTemplate")
                        .WithMany("Tasks")
